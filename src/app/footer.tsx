...
const Footer = () => {
  ...
  <div className="mx-auto max-w-screen-xl px-4 pt-16 pb-8 sm:px-6 lg:px-8 lg:pt-24">
    <div className="text-center">
      <h2 className="text-3xl font-extrabold drop-shadow-2xl text-gray-800 sm:text-4xl">Call for a Free Estimate</h2>

      <div className="mx-auto mt-4 max-w-sm text-gray-700">
        <p className="font-semibold text-2xl">Hours of operation:</p>
        <ul className="mt-2 space-y-1">
          <li>Sunday: Closed</li>
          <li>Monday: 7 AM–8 PM</li>
          <li>Tuesday: 7 AM–8 PM</li>
          <li>Wednesday: 7 AM–8 PM</li>
             <li>Thursday: 7 AM–8 PM</li>
    ...
    >
      <div>
        <p className="text-gray-700 transition hover:opacity-75">
          &copy; {new Date().getFullYear()} Industrial & Commercial Roofing
        </p>
      </div>
