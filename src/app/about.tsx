...
const about = () => {
 ...
 <section className="bg-gray-50 pt-7">
  <div className="mx-auto max-w-screen-2xl px-4 py-8 sm:px-6 lg:px-8 mb-8">
    <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
      ...
      <div className="p-14 lg:p-0">
          ...
          <p className="text-gray-900 text-sm lg:text-xl mx-4 mt-2 sm:mt-4 sm:block">
      We service all of your roofing needs, no matter the size. We specialize in roof repairs, roof maintenance, protective roof coatings, and more.
        ...
        <a
          className="rounded-md bg-gray-800 drop-shadow-2xl px-4 py-4 text-sm font-medium text-white shadow-sm hover:bg-gray-800/75 flex justify-center"
            href="tel:2013970552"
        >
