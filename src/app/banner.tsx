const banner = () => {
    return (
<section className="grid justify-items-center-center bg-[url(../../public/images/sceneryroof.webp)] bg-center bg-no-repeat bg-cover bg-gray-50 lg:grid place-content-center">
